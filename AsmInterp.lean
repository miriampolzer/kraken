...
theorem UInt64_ofInt_natCast_ne_zero (k : Nat) (h_lt : k < 2^64) (h_ne : k ≠ 0) :
  ...
  -- This might work with Mathlib or Batteries. Need to check if this is OK.
  -- Definitions lited below use Batteries
  -- simp only [UInt64.ofInt, ne_eq, UInt64.ext_iff, UInt64.toNat_ofNat, Nat.zero_mod]
  -- omega
  sorry
